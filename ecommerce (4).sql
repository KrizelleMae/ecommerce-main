...
(22, 79825, 'product_img/73e02d91add1bbe722095144502f66dd166715_2.jpg', 'Chair ', 420, 11114);
...
INSERT INTO `order_details` (`order_id`, `name`, `method`, `total`, `address`, `date_ordered`, `delivery_date`, `email`, `status`, `userid`) VALUES
(7, 'Krizelle Mae Falcasantos', 'deliver', 620, 'Curuan, ZC', '2022-03-23', '0000-00-00', 'kriz@gmail.com', 'pending', 11113);
...
--
ALTER TABLE `order_details`
  MODIFY `order_id` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
