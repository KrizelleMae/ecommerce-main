...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2022 at 03:28 PM
...
(9, 70499, 'product_img/2eefe16e67de339080e6c28e47954a77My Snapshot_17.jpg', 'Item 2 sample', 500, 12345);
...
--
ALTER TABLE `users`
  MODIFY `userid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11114;
COMMIT;
